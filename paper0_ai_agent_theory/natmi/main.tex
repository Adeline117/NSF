...
Polygon activity, $29$ were extracted, of which $27$ were retained after class filtering. Applying the
...
\begin{figure}[t]
  ...
  ($n = 27$ addresses after class filtering).} Top: direct transfer of an Ethereum-trained
