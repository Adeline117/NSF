...
$\texttt{eip1559\_tip\_precision}$ at $1.066$ bits ($0.739$ nats),
capturing $74\%$ of the joint $I(X_{31};Y) = 1.437$ bits---confirming
very substantial redundancy among individual features. (Note: per-feature
MI is estimated in nats by \texttt{sklearn}; joint MI is estimated in bits
via our $k$-NN plug-in. Conversions use
$1 \text{ nat} = \log_2 e \approx 1.443 \text{ bits}$.) The second mechanism is the category-level information floor:
